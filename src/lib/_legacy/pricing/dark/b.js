      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="lg:w-1/4 mt-48 hidden lg:block">
          <div className="mt-px border-t border-gray-700 border-b border-l rounded-tl-lg rounded-bl-lg overflow-hidden">
            <p className="bg-gray-800 text-white h-12 text-center px-4 flex items-center justify-start -mt-px">
              Fingerstache disrupt
            </p>
            <p className="text-white h-12 text-center px-4 flex items-center justify-start">
              Franzen hashtag
            </p>
            <p className="bg-gray-800 text-white h-12 text-center px-4 flex items-center justify-start">
              Tilde art party
            </p>
            <p className="text-white h-12 text-center px-4 flex items-center justify-start">
              Banh mi cornhole
        ...
        <div className="flex lg:w-3/4 w-full flex-wrap lg:border border-gray-700 rounded-lg">
          <div
            ...
            <p className="h-12 text-gray-500 px-6 text-center leading-relaxed flex items-center justify-center">
              Feature
            </p>
            <p className="bg-gray-800 text-gray-500 text-center h-12 flex items-center justify-center">
              <span
          ...
          <div
            ...
            <div className="px-2 text-center h-48 flex flex-col items-center justify-center">
              ...
              <h2 className="text-5xl text-white font-medium flex items-center justify-center leading-none mb-4 mt-2">
                $38<span className="text-gray-500 text-base ml-1">/mo</span>
              </h2>
            ...
            <p className="h-12 text-gray-500 text-center leading-relaxed flex items-center justify-center">
              Feature
            </p>
            <p className="bg-gray-800 text-gray-500 text-center h-12 flex items-center justify-center">
              <span
          ...
          <div className="lg:w-1/3 w-full lg:mt-px border-2 border-gray-700 lg:border-none rounded-lg lg:rounded-none">
            <div className="px-2 text-center h-48 flex flex-col items-center justify-center">
              <h3 className="tracking-widest">BUSINESS</h3>
              <h2 className="text-5xl text-white font-medium flex items-center justify-center leading-none mb-4 mt-2">
                $54<span className="text-gray-500 text-base ml-1">/mo</span>
              </h2>
              <span className="text-sm text-gray-500">
